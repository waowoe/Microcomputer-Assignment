...
#define LCD_SCL        	GPIO_Pin_11	//PB6--->>TFT --SCL/SCK
#define LCD_SDA        	GPIO_Pin_10	//PB7 MOSI--->>TFT --SDA/DIN
#define LCD_CS        	GPIO_Pin_5  //PA11 MCU_PB11--->>TFT --CS/CE

#define LCD_LED        	GPIO_Pin_4  // PA8MCU_PB9--->>TFT --BL
#define LCD_RS         	GPIO_Pin_6	//PA12--->>TFT --RS/DC
#define LCD_RST     	GPIO_Pin_7	//PB5--->>TFT --RST

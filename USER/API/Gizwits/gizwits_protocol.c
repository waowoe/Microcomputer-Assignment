...
static int8_t ICACHE_FLASH_ATTR gizDataPoint2Event(gizwitsIssued_t *issuedData, eventInfo_t *info, dataPoint_t *dataPoints)
{
    ...
    if(0x01 == issuedData->attrFlags.flagauto_mode)
    {
        info->event[info->num] = EVENT_auto_mode;
        info->num++;
        dataPoints->valueauto_mode = gizStandardDecompressionValue(auto_mode_BYTEOFFSET,auto_mode_BITOFFSET,auto_mode_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagwind)
    {
        info->event[info->num] = EVENT_wind;
        info->num++;
        dataPoints->valuewind = gizStandardDecompressionValue(wind_BYTEOFFSET,wind_BITOFFSET,wind_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagtemp_door)
    {
        info->event[info->num] = EVENT_temp_door;
        info->num++;
        dataPoints->valuetemp_door = gizX2Y(temp_door_RATIO,  temp_door_ADDITION, issuedData->attrVals.valuetemp_door); 
    }
        
    if(0x01 == issuedData->attrFlags.flaghumi_door)
    {
        info->event[info->num] = EVENT_humi_door;
        info->num++;
        dataPoints->valuehumi_door = gizX2Y(humi_door_RATIO,  humi_door_ADDITION, issuedData->attrVals.valuehumi_door); 
    }
        
    if(0x01 == issuedData->attrFlags.flagsoil_door)
    {
        info->event[info->num] = EVENT_soil_door;
        info->num++;
        dataPoints->valuesoil_door = gizX2Y(soil_door_RATIO,  soil_door_ADDITION, issuedData->attrVals.valuesoil_door); 
    }
        
    if(0x01 == issuedData->attrFlags.flaglight_door)
    {
        info->event[info->num] = EVENT_light_door;
        info->num++;
        dataPoints->valuelight_door = gizX2Y(light_door_RATIO,  light_door_ADDITION, exchangeBytes(issuedData->attrVals.valuelight_door));
    }
        
    if(0x01 == issuedData->attrFlags.flagco2_door)
    {
        info->event[info->num] = EVENT_co2_door;
        info->num++;
        dataPoints->valueco2_door = gizX2Y(co2_door_RATIO,  co2_door_ADDITION, exchangeBytes(issuedData->attrVals.valueco2_door));
    }
...
static int8_t ICACHE_FLASH_ATTR gizCheckReport(dataPoint_t *cur, dataPoint_t *last)
{
    ...
    if(last->valueauto_mode != cur->valueauto_mode)
    {
        GIZWITS_LOG("valueauto_mode Changed\n");
        ret = 1;
    }
    ...
    if(last->valuewind != cur->valuewind)
    {
        GIZWITS_LOG("valuewind Changed\n");
        ret = 1;
    }
    ...
    if(last->valuetemp_door != cur->valuetemp_door)
    {
        GIZWITS_LOG("valuetemp_door Changed\n");
        ret = 1;
    }
    if(last->valuehumi_door != cur->valuehumi_door)
    {
        GIZWITS_LOG("valuehumi_door Changed\n");
        ret = 1;
    }
    if(last->valuesoil_door != cur->valuesoil_door)
    {
        GIZWITS_LOG("valuesoil_door Changed\n");
        ret = 1;
    }
    if(last->valuelight_door != cur->valuelight_door)
    {
        GIZWITS_LOG("valuelight_door Changed\n");
        ret = 1;
    }
    if(last->valueco2_door != cur->valueco2_door)
    {
        GIZWITS_LOG("valueco2_door Changed\n");
        ret = 1;
    }
...
static int8_t ICACHE_FLASH_ATTR gizDataPoints2ReportData(dataPoint_t *dataPoints , devStatus_t *devStatusPtr)
{
    ...
    gizStandardCompressValue(auto_mode_BYTEOFFSET,auto_mode_BITOFFSET,auto_mode_LEN,(uint8_t *)devStatusPtr,dataPoints->valueauto_mode);
    gizStandardCompressValue(led_BYTEOFFSET,led_BITOFFSET,led_LEN,(uint8_t *)devStatusPtr,dataPoints->valueled);
    gizStandardCompressValue(wind_BYTEOFFSET,wind_BITOFFSET,wind_LEN,(uint8_t *)devStatusPtr,dataPoints->valuewind);
    ...
    devStatusPtr->valuetemp_door = gizY2X(temp_door_RATIO,  temp_door_ADDITION, dataPoints->valuetemp_door); 
    devStatusPtr->valuehumi_door = gizY2X(humi_door_RATIO,  humi_door_ADDITION, dataPoints->valuehumi_door); 
    devStatusPtr->valuesoil_door = gizY2X(soil_door_RATIO,  soil_door_ADDITION, dataPoints->valuesoil_door); 
    ...
    devStatusPtr->valuelight_door = exchangeBytes(gizY2X(light_door_RATIO,  light_door_ADDITION, dataPoints->valuelight_door)); 
    devStatusPtr->valueco2_door = exchangeBytes(gizY2X(co2_door_RATIO,  co2_door_ADDITION, dataPoints->valueco2_door)); 
    devStatusPtr->valueco2 = exchangeBytes(gizY2X(co2_RATIO,  co2_ADDITION, dataPoints->valueco2)); 
    devStatusPtr->valuelight = exchangeBytes(gizY2X(light_RATIO,  light_ADDITION, dataPoints->valuelight)); 

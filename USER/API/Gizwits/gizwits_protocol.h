...
* @{
*/
#define PRODUCT_KEY "192a2e499d2e4ca08eab92cc3d6fc0d1"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "68ae472b104d42e1adf5506d1c87f4a3"
...
* @{
*/
#define auto_mode_BYTEOFFSET                    0
#define auto_mode_BITOFFSET                     0
#define auto_mode_LEN                           1
#define led_BYTEOFFSET                    0
#define led_BITOFFSET                     1
#define led_LEN                           1
#define wind_BYTEOFFSET                    0
#define wind_BITOFFSET                     2
#define wind_LEN                           1
#define water_BYTEOFFSET                    0
#define water_BITOFFSET                     3
#define water_LEN                           1

#define temp_door_RATIO                         1
#define temp_door_ADDITION                      0
#define temp_door_MIN                           0
#define temp_door_MAX                           100
#define humi_door_RATIO                         1
#define humi_door_ADDITION                      0
#define humi_door_MIN                           0
#define humi_door_MAX                           100
#define soil_door_RATIO                         1
#define soil_door_ADDITION                      0
#define soil_door_MIN                           0
#define soil_door_MAX                           100
#define light_door_RATIO                         1
#define light_door_ADDITION                      0
#define light_door_MIN                           0
#define light_door_MAX                           5000
#define co2_door_RATIO                         1
#define co2_door_ADDITION                      0
#define co2_door_MIN                           0
#define co2_door_MAX                           2500
#define temp_RATIO                         1
...
typedef struct {
    ...
    bool valuewind;
    bool valuewater;
    uint32_t valuetemp_door;
    uint32_t valuehumi_door;
    uint32_t valuesoil_door;
    uint32_t valuelight_door;
    uint32_t valueco2_door;
    uint32_t valuetemp;
    uint32_t valuehumi;
    uint32_t valuesoil;
    uint32_t valueco2;
...
typedef struct {
    uint8_t flagauto_mode:1;
    uint8_t flagled:1;
    uint8_t flagwind:1;
    uint8_t flagwater:1;
    uint8_t flagtemp_door:1;
    uint8_t flaghumi_door:1;
    uint8_t flagsoil_door:1;
    uint8_t flaglight_door:1;
    uint8_t flagco2_door:1;
} attrFlags_t;
...
typedef struct {
    ...
    uint8_t valuetemp_door;
    uint8_t valuehumi_door;
    uint8_t valuesoil_door;
    uint16_t valuelight_door;
    uint16_t valueco2_door;
} attrVals_t;
